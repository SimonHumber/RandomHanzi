...
import TOCFLPage from './TOCFLPage';
import CharacterListPage from './CharacterListPage';
import Navbar from './Navbar';

function App() {
    const [currentPage, setCurrentPage] = useState('kanji'); // 'kanji', 'hsk', 'tocfl', or 'list'
    ...
    if (currentPage === 'hsk') {
        return (
            <div>
                ...
                <HSKPage onNavigate={setCurrentPage} />
            </div>
        );
    }

    if (currentPage === 'tocfl') {
        return (
            <div>
                <Navbar currentPage={currentPage} onNavigate={setCurrentPage} />
                <TOCFLPage onNavigate={setCurrentPage} />
            </div>
        );
    }
    ...
    if (currentPage === 'list') {
        return (
            <div>
                <Navbar currentPage={currentPage} onNavigate={setCurrentPage} />
                <CharacterListPage onNavigate={setCurrentPage} />
            </div>
        );
    }
